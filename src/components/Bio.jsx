...
const Bio = () => {
  return (
    <section className="flex flex-col gap-2 items-center justify-center w-full h-[400px] text-center">
      ...
      <Link href="https://bit.ly/resumeNamanSharma" target="_blank" className="rounded-full py-1 px-4 text-gray-900 bg-blue-500 transition-all hover:scale-95">Resume</Link>
    </section>
  );
};
